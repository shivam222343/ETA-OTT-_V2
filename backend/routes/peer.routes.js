...
import { requireFacultyOrAdmin } from '../middleware/role.middleware.js';
 ...
 */
router.get('/faculty/student-stats', authenticate, attachUser, requireFacultyOrAdmin, async (req, res) => {
    try {
 ...
 */
router.patch('/:id/review', authenticate, attachUser, requireFacultyOrAdmin, async (req, res) => {
    try {
