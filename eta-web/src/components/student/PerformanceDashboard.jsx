...
export default function PerformanceDashboard({ user }) {
    ...
    const fetchPerformance = async () => {
        try {
            const response = await apiClient.get('/quizzes/performance/me');
    ...
    const fetchHistory = async () => {
        try {
            const response = await apiClient.get('/quizzes/history/me?limit=20');
            if (response.data.success) {
    ...
    const fetchAiAnalysis = async () => {
        ...
        try {
            const response = await apiClient.get(`/quizzes/ai-analysis/me?language=${language}`);
            if (response.data.success) {
